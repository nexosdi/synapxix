...
import { BalanceGameData } from '../../../../libs/game-engine/core/src/lib/game-types/balance-game/balance-game.model';
  ...
  template: `
    <div class="space-y-8 animate-in fade-in zoom-in duration-300">
      ...
      <div class="flex items-center gap-6 justify-between bg-slate-50 p-8 rounded-[3rem] border border-slate-100 shadow-inner">
        ...
        <div class="flex-1 space-y-4">
          <div class="p-6 bg-white rounded-[2rem] shadow-sm border-2 border-blue-100 ring-4 ring-blue-50/50">
            <label class="text-[10px] font-black text-blue-400 block mb-3 uppercase tracking-widest text-center">Lado Izquierdo</label>
            <input type="number" [(ngModel)]="data.leftSide.value" 
            ...
            <input [(ngModel)]="data.leftSide.label" 
            ...
            <input [(ngModel)]="data.leftSide.imageUrl" 
        ...
        <div class="flex-1 space-y-4">
          <div class="p-6 bg-white rounded-[2rem] shadow-sm border-2 border-indigo-100 ring-4 ring-indigo-50/50">
            <label class="text-[10px] font-black text-indigo-400 block mb-3 uppercase tracking-widest text-center">Lado Derecho</label>
            <input type="number" [(ngModel)]="data.rightSide.value" 
            ...
            <input [(ngModel)]="data.rightSide.label" 
            ...
            <input [(ngModel)]="data.rightSide.imageUrl" 
                   class="w-full mt-2 p-2 bg-slate-50 rounded-lg text-[10px] outline-none" placeholder="URL Imagen (opcional)">
          </div>
        </div>
      ...
      <div class="p-6 bg-white border-2 border-slate-50 rounded-[2.5rem] shadow-sm">
        <label class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] block mb-6 text-center">Definir Respuesta Correcta</label>
