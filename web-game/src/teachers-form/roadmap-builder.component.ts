        ...
        @if (editingIndex() !== null && currentForm()) {
          <div class="bg-white p-10 rounded-[40px] shadow-2xl border-2 border-emerald-500 ring-[12px] ring-emerald-500/5">
            ...
            <div class="mb-8 p-6 bg-slate-50 rounded-3xl">
              <label for="studentPrompt" class="text-[10px] font-black text-slate-400 uppercase mb-2 block tracking-widest">Prompt del Alumno</label>
              <input id="studentPrompt" [(ngModel)]="tempGameInput.prompt" class="w-full p-4 bg-white border-none rounded-2xl shadow-sm outline-none focus:ring-2 focus:ring-emerald-500" 
