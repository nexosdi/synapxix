  ...
  template: `
    ...
    >
      <header class="space-y-2">
        <p
          class="text-sm font-semibold uppercase tracking-[0.3em] text-amber-500"
        >
          Fill in the blanks
        </p>
        ...
        <p
          class="rounded-2xl border border-amber-100 bg-white/70 px-5 py-4 text-lg font-semibold text-slate-800 shadow-inner shadow-amber-900/5"
        >
          {{ view.sentence }}
        </p>
      </header>
      ...
      <ol class="space-y-4">
        ...
        <li
          class="rounded-2xl border border-slate-200 bg-white/95 px-5 py-4 shadow-sm shadow-slate-900/5"
        >
