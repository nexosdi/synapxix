  ...
  template: `
    ...
    >
      <header class="space-y-2">
        <p
          class="text-sm font-semibold uppercase tracking-[0.28em] text-fuchsia-500"
        >
          Read Aloud
        </p>
        ...
        <p
          class="rounded-2xl border border-fuchsia-100 bg-white/80 px-5 py-4 text-base font-medium text-fuchsia-900 shadow-inner shadow-fuchsia-900/5"
        >
          {{ view.text }}
        </p>
      </header>
      ...
      <ul
        class="grid gap-3 rounded-2xl border border-fuchsia-100 bg-white/90 px-5 py-4 text-sm text-fuchsia-900 shadow-inner shadow-fuchsia-900/5"
      >
        <li class="flex items-center justify-between">
          Recording window:
          <strong class="text-base text-fuchsia-600">
            {{ view.recording.minDurationSec }}-{{
              view.recording.maxDurationSec
            }}s
          </strong>
        </li>
        <li class="flex items-center justify-between">
      ...
      @if (view.media) {
      <footer
        class="rounded-2xl border border-fuchsia-100 bg-fuchsia-50 px-4 py-3 text-sm text-fuchsia-700"
      >
