...
export class AvatarGameComponent {
  ...
  onSelectAvatar(id: string) {
    if (this.selectedId()) return; // Evitar múltiples selecciones rápidas

    this.selectedId.set(id);

    // Como es una elección libre, esperamos un momento para que el niño vea su selección
    // y avanzamos automáticamente al siguiente nivel.
    setTimeout(() => {
